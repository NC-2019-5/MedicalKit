...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .cors()
                .and()
                .authorizeRequests().antMatchers("/login", "/register", "/forgot-password", "/reset-password", "/webjars/**", "/v2/api-docs/**", "/configuration/ui/**", "/swagger-resources/**",
                "/configuration/security/**", "/swagger-ui.html/**", "/swagger-ui.html#/**")
                    .permitAll()
                .antMatchers(HttpMethod.DELETE, "/all-medicines/**")
                    .hasAuthority(Role.ADMINISTRATOR.getAuthority())
                .antMatchers(HttpMethod.POST, "/all-medicines/**")
                    .hasAuthority(Role.ADMINISTRATOR.getAuthority())
